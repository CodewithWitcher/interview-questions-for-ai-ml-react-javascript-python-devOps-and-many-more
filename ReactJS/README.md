...
**Note:** This repository is specific to ReactJS. You can use the local [JavaScript section](../JavaScript/) for core JavaScript questions and [DSA section](../DSA-Coding-Patterns/) for DSA patterns.
...
7.  ### When to use a Class Component over a Function Component?
    ...
    **Note:** You can also use a reusable third-party `react-error-boundary` package without writing any class. i.e, No need to use class components for Error boundaries.
...
211. ### What is your favorite React stack?
    ...
    You can also start from a standard React boilerplate template and adapt it for new projects.
